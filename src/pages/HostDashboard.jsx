...
import { Plus, TrendingUp, Calendar, Star, Users, Eye, Edit, Trash2, MapPin, Clock, DollarSign, MessageCircle, Award, Home } from 'lucide-react';
import { mockExperiences, mockHost, mockBookings } from '../data/mock';

const HostDashboard = () => {
	const navigate = useNavigate();
	const [hostData] = useState(mockHost);
